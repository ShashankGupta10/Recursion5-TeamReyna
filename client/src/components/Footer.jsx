export default function Footer () {
    ...
    const footerNavs = [
        ...
        },
        {
            ...
            items: [
                {
                    href: 'https://www.linkedin.com/in/shashankgupta10/',
                    name: 'Shashank Gupta'
                },
                {
                    href: 'https://www.linkedin.com/in/pranav-p-4206a8233/',
                    name: 'Pranav Patil'
                },
                {
                ...
                {
                    href: 'https://www.linkedin.com/in/mamta-gupta-434782262/',
                    name: 'Mamta Gupta'
                },
            ],
        }
    ...
    return (
        <footer className="pt-4 bg-gray-800 ">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <div className="mt-10 py-4 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2022 Float UI Inc. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-400 mt-6">
                        <a href="https://github.com/ShashankGupta10/RJIT_team_reyna">
